...
(function () {
    angular.module('homer', [
        ...
        'satellizer'                 // Satellizer Token Authentication
    ])
})();
    ...
    return {
        link: function(scope, element) {
            var listener = function(event, toState, toParams, fromState, fromParams) {
                // Default title
                var title = 'lcFramework';
                // Create your own title pattern
                if (toState.data && toState.data.pageTitle) title = 'lcFramework | ' + toState.data.pageTitle;
                $timeout(function() {
                    element.text(title);
                });
            };
...
function calendarCtrl($scope, notify) {
